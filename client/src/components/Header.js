        ...
        <>
          ...
          <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-end">
            <Nav >
              ...
              <Nav.Link as={Link} to="/workouts" eventKey="3">workouts</Nav.Link>
              {/* <Nav.Link as={Link} to="/addworkoutplan" eventKey="4">Addworkoutplan</Nav.Link> */}
              <Nav.Link as={Link} to="/workoutplan" eventKey="5">workoutplan</Nav.Link>
              <Nav.Link as={Link} to="/meals" eventKey="6">meals</Nav.Link>
