...
// Create a new meal
export const createMeal = (mealData, token) => {
...
// Get a meal by ID
export const getMealById = (mealId, token) => {
...
export const createWorkoutplan = (workoutdata, token) => {
...
export const getWorkoutById = (workoutId, token) => {
  return fetch(`/api/workout/${workoutId}`, {
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
    }
